          ...
          <div class="col-md-12" style="padding-bottom:60px;">
            <div class="item active left">
              <div class="col-md-6 col-sm-6 left-images">
                <img src="${context}/resources/img/pink_tae.jpg" class="img-responsive">
              </div>
      ...
      <div class="row">
        ...
        <div id="menu-wrapper">
          ...
          <div class="breakfast menu-restaurant">
            <span class="clearfix">
              <a class="menu-title" href="#" data-meal-img="${context}/resources/img/taehyung.jpg">Food Item Name</a>
